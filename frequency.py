...
with col1:
    alpha_bd = st.slider(r'$\mathrm{\alpha_{bd}}$', min_value=-2.0, max_value=2.0, value=-0.21, step=0.01)
    A_bd_ln = st.slider(r'$\mathrm{ln(A_{bd})}$', min_value=-10.0, max_value=5.0, value=-5.28, step=0.01)
    mean_bd = st.slider(
