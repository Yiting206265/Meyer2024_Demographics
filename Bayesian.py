...
st.title("Bayesian Demographic Modeling")

st.write(f"Demographics code for characterizing a companion population given the results of a direct imaging survey. This program will find the best-fit log-normal separation distribution and power-law mass ratio distribution to an input companion list and detection probability map. The detection probability map is really the sum of all contrast curves for each source in separation and mass ratio space.")
